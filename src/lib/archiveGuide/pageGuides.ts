...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'Copy invite link (Friends header) shares one reusable link — viewers who sign in send you a pending request (you still Accept/Deny); requires verified RSI Handle',
      'Rotate invite link under Settings → Security if you need to invalidate an old posted link — Copy never rotates by itself',
