...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      '**CHP** (Crew Head Plan) beside OCR when **Crew** is checked on Mole — crew throttle plan for the rock in your calculator (mass + resistance required). Same panel as Smart Cracker crew mode',
      '**SHP** (Solo Head Plan) beside OCR in solo mode — on **Mole**, shows which head fits the current rock (when mass/resistance are set) plus solo garage role suggestions per head; on **Prospector, Golem, ROC**, shows pro-tip suggestions only (no full stat breakdown)',
