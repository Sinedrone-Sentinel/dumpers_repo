...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      '**SHP** (Solo Head Plan) in the calculator header in solo mode — on **Mole**, shows which head fits the current rock (when mass/resistance are set) plus solo garage role suggestions per head; on **Prospector, Golem, ROC**, shows pro-tip suggestions only (no full stat breakdown)',
