...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      '**Keep App Up to Date** defaults to Yes — when a new Dumper Apps release ships, the app downloads it and restarts itself',
      'Older Dumper Apps builds are blocked by the server — download the latest Windows portable exe from this page if prompted to update',
