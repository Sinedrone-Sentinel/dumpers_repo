...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'On an accepted deal, Message opens a private chat with the other party (both sides need a verified RSI Handle). Chat closes and messages are removed when the deal completes or cancels',
  ...
  },
  {
    ...
    details: [
      ...
      'Message on an accepted sale or fulfillment opens the same deal chat as My Listings — both parties must have a verified RSI Handle',
  ...
  },
  {
    ...
    details: [
      ...
      'My activity: pings when someone else moves your deal forward (accepted, ready, completed, released, deal chat, etc.) — requires verified RSI Handle',
