...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      '**Scanner OCR** (button in the calculator header): from the **Mole pilot seat**, ALT+PrtSc the **RESULTS** panel on the right (RESULTS header, ore name, MASS, RES, INST, COMP xx SCU, and composition % rows with Q numbers). Paste with Ctrl+V, crop that block, and **Process** to auto-fill. Primary ore comes from under RESULTS; duplicate lines for the same ore sort High/Low by **smaller % = High**',
