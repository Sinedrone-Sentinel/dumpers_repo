...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      'Mining loadout panel (signed-in members): pick ship and loadout, compare laser power to a rock from the calculator — RSI verification not required',
      ...
      'Breakability check: required MW vs loadout total; Mole shows per-laser share, throttle %, and shortfall',
