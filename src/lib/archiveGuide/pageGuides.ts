...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      '**Windows:** download **Windows portable exe**, run it, then paste your API key when prompted',
      ...
      'On the Windows portable exe, **Keep App Up to Date** defaults to Yes — when a new release ships, the app can download it and restart',
      'Older builds are blocked by the server — get the latest Windows portable exe or pull updated scripts if prompted to update',
