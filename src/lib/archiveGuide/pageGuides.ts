...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'After you position or resize the orange crop box once, that **size and position are remembered** on your device for the next scan — paste and Process without re-adjusting when your HUD layout stays the same',
