...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      '**Scanner OCR** (signed-in members only — button in the calculator header): run **Dumper Apps** / BP Dumper in watch mode on the same PC, then click **OCR** while the Mole pilot **RESULTS** panel is open in-game. Capture briefly switches to Star Citizen to grab your HUD, then returns to the Rock Calculator tab with live scan progress while your PC reads the panel — mass, RES, INST, COMP SCU, composition %, and Q bands. **First-time setup:** right-click the Dumper Apps tray icon → **Calibrate RESULTS panel** (draw the box once per resolution). If OCR fails, confirm Dumper Apps is still running in watch mode',
  ...
  },
  {
    ...
    details: [
      ...
      'Run watch mode while you play; use Live Tracker to see active missions and remaining pool blueprints',
