...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'Same reputation ratings for all paths; visible fulfiller/seller rep shows average delivery time (ddd:HH:mm from accept to ready) after 5 completed items. Click a visible star rating to read optional comments from each rating',
