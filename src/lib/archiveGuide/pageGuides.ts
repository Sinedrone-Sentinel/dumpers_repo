...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'Signed-in members can open the **Advisor** chat in Smart Cracker for loadout ideas. It does not change your heads or Save. Paste your own free or paid Gemini access each visit (we do not save it). **Use scanned info** sends this rock’s mass, resistance, and instability; turn it off for ideas about the same resource without using that scan',
