...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      '**Windows (recommended):** download **DumperApps.exe** — auto-detects LIVE (or paste a path), then paste your API key. This build is **unsigned**; Windows Defender / SmartScreen often block it (false positive)',
