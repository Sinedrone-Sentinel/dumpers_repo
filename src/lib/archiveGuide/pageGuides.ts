...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      '**CHP** (Crew Head Plan) in the calculator header when **Crew** is checked on Mole — crew throttle plan for the rock in your calculator (mass + resistance required). Same panel as Smart Cracker crew mode',
