...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'Belt and cluster tooltips include a 📍 **find-it-in-game** hint: which QT markers or starmap search terms to use (e.g. Akiro Cluster sits near Pyro I L3; Pyro belts list their PYAM/RAB station markers)',
