...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      'Sticky mining workspace at the top: Rock Calculator scanner row stays on screen while you scroll tracked ores',
      'Rock Calculator: enter mass, instability, and resistance from the fracture scanner; required MW updates live',
      'Expand Composition & ledger for SCU, material %, DFP, and RSI-verified ledger export',
      'Composition rows: compact Q band picker for ledger export (Purchased Q0 plus Bands 1–8; Band 2 default); DFP column always shows Purchased (Q0) value; Inert % auto-fills',
      'Smart Cracker (collapsible, collapsed by default — expand/collapse state is saved in your browser): loadout planner, breakability, Mole head plan, and gadget fit',
      'Signed-in members: pick ship and loadout — RSI verification not required; loadouts sync across devices',
      ...
      'Custom loadouts: choose mining head model, equip mining modules (Focus, Rieger, FLTR, etc.), and enable My crafted mining head to enter blueprint craft slot qualities',
      'Crafted head power scales from blueprint damage modifiers; optional label for each custom head',
      'Breakability check: required MW vs loadout total; warns when rock MW is below a head\'s minimum throttle (any ship/loadout)',
      ...
      'Click a tracked card to load its ore into the Rock Calculator; Surface/Asteroid toggle defaults to Asteroid',
