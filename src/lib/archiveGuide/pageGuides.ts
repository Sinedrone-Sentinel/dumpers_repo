...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      '**SHP** (Solo Head Plan) beside OCR in solo mode — on **Mole**, shows which head fits the current rock (when mass/resistance are set) plus solo garage spread; on **Prospector, Golem, ROC**, shows your loadout breakdown with pro-tips',
