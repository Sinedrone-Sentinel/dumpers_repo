...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      '**Scanner OCR** (button in the calculator header): ALT+PrtSc the in-game SCAN RESULTS panel, paste here with Ctrl+V, crop the scan area, and **Process** to auto-fill mass, resistance, instability, SCU, composition %, and Q bands',
