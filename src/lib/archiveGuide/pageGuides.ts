...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'Mission tag order: Verified/Unverified → mobiGlas contract type → system/location → career path standing → aUEC → rep points (then prereq / drop % when relevant); a second row shows how many offers and how often the board refreshes when the game files list those values',
