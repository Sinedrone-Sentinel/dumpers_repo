...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'Breakability check: required MW vs loadout total; warns when a head cannot reach the fracture band near the resistance equalizer',
      'Mole crew head plan: driving laser at min throttle (1–5% of equalizer), supplementary laser matches resistance at a tuned % just under equalizer — instructions use whole-number throttle % only',
      'Smart Cracker: head plan first, then final gadget fit from that plan — Mole solo picks your best single head (~3% under equalizer); uncheck solo if friends run extra turrets',
