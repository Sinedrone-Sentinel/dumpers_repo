...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'Signed-in members can open the **Advisor** chat in Smart Cracker for loadout ideas. It does not change your heads or Save. Paste your own free or paid Gemini access each visit, or **Save to my profile** with a lock phrase — that copy is encrypted on your device before it is stored, and only that phrase unlocks it. If nothing is saved, you paste again next time. Clear a saved copy from Settings (the key is never shown). **Use scanned info** sends this rock’s mass, resistance, and instability; turn it off for ideas about the same resource without using that scan',
