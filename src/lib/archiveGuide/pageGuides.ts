...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'WHAT\'S NEW lines summarize Blueprints, Missions, Resources, Components, Wikelo, Misspellings, and more from the latest parse — each stays for 7 days',
      'Click a WHAT\'S NEW line to see the full item list in a modal',
