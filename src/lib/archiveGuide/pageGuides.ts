...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'On a WTS listing, check Deduct from My Resources on commodity lines to pull that stock from My Resources when you mark the sale ready (at the listed quality). Finished blueprint items are not deducted',
  ...
  },
  {
    ...
    details: [
      ...
      'When fulfilling a WTB line, you can check Deduct from My Resources to pull that line’s materials at the listed qualities when you mark the craft ready. Checkboxes disable in real time if remaining stock at those qualities is not enough',
