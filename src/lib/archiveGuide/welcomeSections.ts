...
export const PENDING_REP_SECTION = {
  ...
  sellerLimits: {
    ...
    items: [
      ...
      'After that, others see your star rating plus average delivery time (ddd:HH:mm from accept to ready). Click a visible star rating to read optional comments',
    ],
  },
  important:
