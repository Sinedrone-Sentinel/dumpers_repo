        ...
        <article className="site-surface space-y-6 p-5 sm:p-7 text-sm leading-relaxed text-slate-300">
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              in sync. Microsoft Store builds keep app data under your local app data folder and do not use
              the app&apos;s GitHub auto-update path used by some non-Store builds.
            </p>
          </section>
