...
- **Match locations** — when checked, unique stock notes become location filter chips (ignores case, spaces, and punctuation so `arcL1` / `Arc l1` / `ARC-l1` collapse to one)
