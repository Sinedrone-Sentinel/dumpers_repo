...
1. Database — [docs/SUPABASE_SETUP.md](docs/SUPABASE_SETUP.md)  
   Apply migrations in numeric order through **`184_anonymous_order_rating_list.sql`** (see full table in `SUPABASE_SETUP.md`)
