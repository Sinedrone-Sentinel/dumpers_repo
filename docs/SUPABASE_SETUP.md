...
**Latest migration:** `167_friends_notify_actions_reorder_groups.sql` (friend request Accept/Deny/Cancel via Notify; reorder friend groups). Apply missing files in numeric order if catching up. Bot setup: [`docs/DUMPER_SERVICES_BOT.md`](DUMPER_SERVICES_BOT.md).
