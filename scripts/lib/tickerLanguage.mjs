...
const FIELD_LABELS = {
  ...
  category: 'Category',
  catastrophicChargeWindowRateModifier: 'Overcharge rate',
  clusterFactorModifier: 'Cluster factor',
  costs: 'Hand-in cost',
  filterModifier: 'Inert filter',
  instabilityModifier: 'Laser instability',
  isVehicleReward: 'Vehicle reward',
  maxPerPlayer: 'Max per player',
  maxStanding: 'Maximum standing',
  minStanding: 'Minimum standing',
  optimalWindowModifier: 'Charge window',
  optimalWindowRateModifier: 'Charge window rate',
  powerMultiplier: 'Laser power',
  ...
  rewards: 'Rewards',
  shatterDamageModifier: 'Shatter damage',
